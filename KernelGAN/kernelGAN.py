...
import KernelGAN.networks as networks
...
class KernelGAN:
    ...
    def __init__(self, conf, QMainWindow):
    ...
    def finish(self, QMainWindow):
        ...
        QMainWindow.label_status.setText("During ZSSR configuration")
        QMainWindow.progressBar.setValue(0)
        run_zssr(final_kernel, self.conf, QMainWindow)
