...
class ZSSR:
    ...
    def __init__(self, input_img_path, scale_factor=2, kernels=None, is_real_img=False, noise_scale=1, QMainWindow= QMainWindow):
    ...
    def train(self, QMainWindow):
        ...
        for self.iter in tqdm.tqdm(range(self.conf.max_iters), ncols=60):
            ...
            QMainWindow.progressBar.setValue(self.iter / self.conf.max_iters * 100)
